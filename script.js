...
const zombieHeadImages = [
  ...
  "https://i.ibb.co/4VNP0k1/Roni.png",
  "https://i.ibb.co/BnNXY47/Vijea.png",
  "https://i.ibb.co/mhxyfp4/Fritz.png",
  "https://i.ibb.co/BnNXY47/Vijea.png",
"https://i.ibb.co/4VNP0k1/Roni.png",
  "https://i.ibb.co/mhxyfp4/Fritz.png",
];
...
class GameBackground extends GameObject {
  constructor() {
    super();    
    this.bgSprite = Sprite.fromUrl("https://i.ibb.co/z2sy3TL/Wallpaper.png");
...
const spawnHead = () => {
  game.addObject();
  setTimeout(spawnHead, (1-(game.score/1)) + (Math.random() * 10000-(game.score/1)));
};
